  ...
  return (
    ...
    >
      <div className="space-y-6 pb-8">
        ...
        {/* Table */}
        <div className="bg-white dark:bg-slate-900/70 backdrop-blur-md rounded-2xl border border-slate-200/60 dark:border-slate-700/60 shadow-sm overflow-hidden">
          <div className="p-0">
            {isLoading ? (
