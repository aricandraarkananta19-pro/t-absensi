        ...
        <div className="flex flex-col min-h-screen bg-[#F8FAFC] pb-[100px] font-sans">
            ...
            <div className="px-6 -mt-8 relative z-20">
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                    <div className="bg-white p-4 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.04)] border border-slate-100 flex flex-col items-center text-center">
                ...
                <div className="space-y-3">
                    {leaveRequests.length === 0 ? (
                        <div className="bg-white rounded-2xl p-8 border border-slate-100 text-center flex flex-col items-center justify-center">
                            ...
                            <span className="text-xs font-medium text-slate-500 mt-1">Anda belum pernah mengajukan cuti.</span>
                        </div>
                    ) : (
                        leaveRequests.map((req) => (
                            <div key={req.id} className="bg-white p-4 rounded-[20px] shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-slate-100">
                                ...
                                {req.reason && (
                                    <p className="text-[12px] font-medium text-slate-500 bg-slate-50 p-2.5 rounded-xl border border-slate-100">
                                        "{req.reason}"
                                    </p>
                                )}
